  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: '545px', background: '#f1f7fe' }}>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to right, #f1f7fe 0%, #f1f7fe 30%, rgba(241,247,254,0.85) 50%, rgba(241,247,254,0.0) 70%, transparent 70%)',
        }}
      />
      ...
      <div
        ...
        style={{ maxWidth: '540px', minHeight: '545px' }}
      >
        ...
        <div className="flex flex-wrap gap-3 hero-anim" style={{ animationDelay: '0.82s' }}>
          <button className="flex items-center gap-2.5 bg-[#0a2558] text-white rounded-md font-bold tracking-widest hover:bg-[#0d3070] transition-colors"
            style={{ padding: '13px 22px', fontSize: '12px' }}>
