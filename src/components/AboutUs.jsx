...
export default function AboutUs() {
  ...
  return (
    <section className="overflow-hidden py-16 lg:py-24 px-5 md:px-10 lg:px-[52px]" style={{ background: '#fff' }} ref={ref}>
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">

        {/* ══════ LEFT ══════ */}
        <div
          className={`w-full lg:w-[46%] lg:shrink-0 relative anim-fade-left ${inView ? 'anim-in' : ''}`}
          style={{ height: '280px' }}
        >
          {/* ── MOBILE: single image ── */}
          <div className="lg:hidden w-full h-full overflow-hidden rounded-3xl">
            <img
            ...
            />
            <div className="absolute inset-0 rounded-3xl" style={{ background: 'linear-gradient(to top, rgba(10,37,88,0.65) 0%, transparent 55%)' }} />
          ...
          <div className="hidden lg:block absolute inset-0" style={{ height: '580px' }}>
            ...
            {/* Main tall image */}
            <div className="absolute overflow-hidden" style={{ width: '68%', height: '100%', right: 0, top: 0, zIndex: 2, borderRadius: '28px', boxShadow: '0 32px 72px rgba(10,37,88,0.18)' }}>
              <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80" alt="Professional care" className="w-full h-full" style={{ objectFit: 'cover', objectPosition: 'center' }} />
              <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(10,37,88,0.72) 0%, rgba(10,37,88,0.1) 45%, transparent 65%)' }} />
            ...
            {/* Top-left small */}
            <div className="absolute overflow-hidden" style={{ width: '38%', height: '46%', left: 0, top: 0, zIndex: 3, borderRadius: '24px', boxShadow: '0 18px 48px rgba(10,37,88,0.16)', border: '4px solid white' }}>
              <img src="https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?w=500&q=80" alt="Caring driver" className="w-full h-full" style={{ objectFit: 'cover', objectPosition: 'center top' }} />
            </div>

            {/* Bottom-left small */}
            <div className="absolute overflow-hidden" style={{ width: '38%', height: '40%', left: 0, bottom: '10px', zIndex: 3, borderRadius: '24px', boxShadow: '0 18px 48px rgba(10,37,88,0.16)', border: '4px solid white' }}>
              <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=500&q=80" alt="Medical professional" className="w-full h-full" style={{ objectFit: 'cover', objectPosition: 'center top' }} />
            ...
            <div className="absolute flex flex-col items-center justify-center z-10" style={{
              ...
              left: 'calc(38% - 41px + 4px)', top: '46.5%',
            ...
            <div className="absolute flex items-center gap-3 z-10" style={{
              right: '-20px', bottom: '30px', background: 'white',
              borderRadius: '18px', padding: '13px 18px',
              boxShadow: '0 16px 40px rgba(10,37,88,0.14)', minWidth: '190px',
            }}>
        ...
        {/* ══════ RIGHT: Content ══════ */}
        <div className={`flex-1 w-full anim-fade-right ${inView ? 'anim-in' : ''}`} style={{ transitionDelay: '0.15s' }}>
          ...
          <h2 className="font-black text-[#0a2558] leading-[1.1] mb-6" style={{ fontSize: 'clamp(26px, 4vw, 42px)' }}>
          ...
          <p className="text-gray-700 leading-relaxed mb-8" style={{ fontSize: '15px', maxWidth: '480px' }}>
          ...
          <div className="flex flex-col gap-4 mb-9">
            {highlights.map((h, i) => (
              <div key={h.title} className="flex items-start gap-4 rounded-2xl p-4" style={{ background: '#f8faff', border: '1px solid #e8eef8' }}>
                <div className="shrink-0 w-10 h-10 rounded-xl flex items-center justify-center font-black text-white" style={{ background: '#0a2558', fontSize: '15px' }}>
                  0{i + 1}
                </div>
                <div>
          ...
          <div className="rounded-2xl px-5 py-4 mb-8 flex items-start gap-3" style={{ background: '#f1f7fe', borderLeft: '4px solid #f97316' }}>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button className="bg-[#0a2558] text-white font-bold rounded-xl hover:bg-[#0d3070] transition-colors tracking-widest" style={{ padding: '14px 28px', fontSize: '13px' }}>
              BOOK A RIDE
            </button>
            <a href="#" className="flex items-center gap-2 text-[#0a2558] font-bold text-sm hover:text-orange-500 transition-colors">
              <span className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: '#f1f7fe' }}>
